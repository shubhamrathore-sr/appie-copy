...
<link rel="stylesheet" type="text/css"
	href="/assets/css/multipleleads.css" />
		...
		<div class="main-container">
			<div class="head">
				...
				<div style="display: flex; width: 40%; justify-content: flex-end;">
					<button class="btn-1 button">Add Leads</button>
				</div>
			</div>
			<div id="all-leads">
			</div>
	...
	$(document)
			.ready(
					function() {
						...
						$
								.get(
										"/leads?method=GET_LEADS&managerID=<%=managerID%>&offset=0&limit=10",
										function(data) {
											leadDataGlobal=data;
		...
		var salesContactPersons = JSON.parse(persons);
							...
							for (i = 0; i < salesContactPersons.length; i++) {
								...
								var person = '<div class="child-container slide sales-contact-person" id="'+salesContactPersons[i].id+'">'
										+ '<h3 class="user-name">'
										+ salesContactPersons[i].personName
										+ '</h3>'
